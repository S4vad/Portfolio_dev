    ...
    <div className="p-5 md:p-10  md:w-[50%] space-y-8 w-full transition-all duration-700 opacity-0 blur-md animate-fade-in">
      <div className="flex-col">
        ...
        <p className="text-neutral-400 leading-loose text-justify  text-[13px]  tracking-wide">
          ...
          self-improvement and success. The insights about the mind's potential
          to shape reality fascinated me, and I realized how powerful our
          thoughts can be in driving positive change.
        </p>
      </div>
      <div className="flex-col">
        <h2 className="text-lg text-white mb-3 dark:text-[#212529]">
        ...
        <p className="text-neutral-400 leading-loose text-justify  text-[13px]  tracking-wide">
          ...
          something entirely new rather than simply improving existing ideas. It
          challenged me to think bigger and inspired me to approach my own
          projects with a more creative mindset.
        </p>
      </div>
      <div className="flex-col">
        <h2 className="text-lg text-white mb-3 dark:text-[#212529] ">
        ...
        <p className="text-neutral-400 leading-loose text-justify  text-[13px]  tracking-wide">
          ...
          openly discusses the difficulties founders face, from making tough
          decisions to handling unexpected challenges. It’s teaching me that
          embracing discomfort and uncertainty is often the key to long-term
          success.
        </p>
      </div>
      <div className="flex-col">
        ...
        <p className="text-neutral-400 leading-loose text-justify  text-[13px]  tracking-wide mb-2">
          ...
          applied in my projects and personal growth. The habit of reading has
