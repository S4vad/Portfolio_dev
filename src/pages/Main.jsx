  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h1 className="text-white text-2xl font-md">Muhammed Savad K</h1>
        <button className="items-center hover:scale-105 px-3 py-1 flex border border-gray-500 hover:border-neutral-500 transition-all space-x-2 rounded-3xl">
          <div>
            <svg
              stroke="currentColor"
              fill="white"
      ...
      <p className="text-[#aaa] text-md">
        I'm a developer based in India. My interests lie around GenAI, web
        development, and solving actual problems using code. I've built various
        projects to improve efficiency and productivity.
      </p>
      <p className="text-[#aaa] text-md">
        I wrote my first line of code in 2022. During my college years, I gained
        experience through internships, freelance projects, and by attending and
        organizing developer events. In 2022, I graduated with a degree in
        computer science from India. Currently, I'm pursuing my MCA while
        working as a freelance web developer.
      </p>
      <span className="text-[#aaa] text-md mb-10">
        you can find me on&nbsp;
        <a
      ...
      <div class="flex items-center mt-5 gap-3 flex-wrap text-white">
        <div class="flex items-center text-sm hover:scale-[1.05] rounded-full transition-all cursor-pointer gap-2 px-3 py-1 border border-neutral-600">
          <svg
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
