  ...
  return (
    <div className="p-5 md:p-10  md:w-[50%] space-y-8 w-full transition-all duration-700 opacity-0 blur-md animate-fade-in">
      <div className="flex flex-col mb-3">
        <h1 className="text-xl text-white dark:text-[#212529] mb-3">
      ...
      <p className="text-neutral-400 leading-loose text-justify  text-[14px]  tracking-wide">
      ...
      <div className="flex-col">
        <h2 className="text-lg text-white mb-3 dark:text-[#212529] "> The Idea Behind Bizfluenc</h2>
        <p className="text-neutral-400 leading-loose text-justify  text-[14px]  tracking-wide mb-2">
      ...
      <div className="flex-col">
        ...
        <ul className="list-disc pl-5  text-neutral-400 leading-loose text-justify  text-[13px]  tracking-wide">
          <li className="pl-2">
            <span className="text-[14px] dark:text-gray-500  font-medium text-neutral-300">
      ...
      <div className="flex-col">
        <h2 className="text-lg text-white mb-3 dark:text-[#212529] "> The Road Ahead</h2>
